...
def find_similar_occupation_pay(code: str, all_occupations: Dict[str, dict]) -> Optional[int]:
...
def infer_pay(occ: dict, stats: Dict, all_occupations: Dict[str, dict]) -> Optional[int]:
...
def main():
    ...
    print("\nNext steps:")
    print("  1. Run: uv run python build_site_data.py")
